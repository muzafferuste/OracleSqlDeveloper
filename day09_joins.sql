...
------------------------------------------------------------------------------*/
    ...
    -- Bir tabloda olupda digerlerine olmayan alanlara null atandi.
    -- Join isleminde genelde iki tablodaki ortak olarak bulunan sutun, ON 
    -- cumleciginde kosul yapisi olarak kullanilir.
...
------------------------------------------------------------------------------*/
    SELECT s.sirket_id, s.sirket_isim, sp.siparis_id, sp.siparis_tarihi
    FROM sirketler s
...
/* -----------------------------------------------------------------------------
  ...
  siparis_id ve siparis_tarihleri listeleyen bir sorgu yaziniz.
------------------------------------------------------------------------------*/
    SELECT s.sirket_id, sp.sirket_id, s.sirket_isim, sp.siparis_id, sp.siparis_tarihi
    FROM sirketler s
...
------------------------------------------------------------------------------*/
    ...
    -- ancak ortak olmayan kisimlar null olarak atanir.