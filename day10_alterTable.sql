...
------------------------------------------------------------------------------*/
    ...
    ALTER TABLE isciler
    MODIFY isim VARCHAR2(50);     -- Veritipini CHAR(100) olarak degistirdik.
    
    ALTER TABLE isciler
    MODIFY maas CHECK (maas >= 3500);   -- Maas alt limit kisitlamasi atadik.
   
    INSERT INTO isciler VALUES(123452310, 'Hatice Sahin', 'Bursa', 3000,'Almanya', 'Kadýn');
    --HATA VERDI CUNKU maas>=35000 OLSUN DEDIK.
    SELECT * FROM isciler;